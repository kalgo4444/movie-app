...
const PeopleDetail = () => {
  ...
  const { data: peopleData, isFetched: peopleFetching } = getPeopleById(id);
    ...
    <section className="mt-20">
      <div className="container">
        <div className="flex flex-col md:flex-row gap-10 border">
          ...
          <div>
            <img width={500} src={`${IMAGE_URL}${peopleData?.profile_path}`} alt={peopleData?.name} className='block mx-auto' />
          </div>
          </div>
